...
## Project Structure
    ...
    ├── testapiautosettings_88202  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_88202`
...
2. Clone this repo and `cd testapiautosettings_88202`
